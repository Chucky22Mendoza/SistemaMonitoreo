...
public final class Lista extends javax.swing.JFrame {
    ...
    public static List mandarHoras() {
        return hora;
    }
    ...
    public static void obtencionLista() {
        hor = obtencionHora();
        min = obtencionMinutos();
    ...
    public static void llenadoTabla() {
    ...
    public static void obtencionDia() {
        String dia = "";
    ...
    private static javax.swing.JTable listaReproduccion;
