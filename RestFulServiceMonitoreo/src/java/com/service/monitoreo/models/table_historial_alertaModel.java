 ...
 */
public class table_historial_alertaModel {
    ...
    public table_historial_alertaModel() {
    }

    public table_historial_alertaModel(int id_historial_alerta, String mensaje, Timestamp fecha_hora, boolean status, int id_evento, int id_kiosco) {
