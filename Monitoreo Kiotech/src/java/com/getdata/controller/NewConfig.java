...
public class NewConfig {
    ...
    public int nuevaConfiguracionSMS(String puerto){
    
    String sql ="INSERT INTO configuracion_envio(id_configuracion_envio,puerto_tarjeta_sms)  VALUES(default,?);";
