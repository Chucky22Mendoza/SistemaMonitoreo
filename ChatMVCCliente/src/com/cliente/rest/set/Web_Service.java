 ...
 * USAGE:
 * <pre>
 *        Web_Service client = new Web_Service();
...
public class Web_Service {
    ...
    public void Web_Service() throws IOException{
        p = new Properties();
    ...
    private static final String BASE_URI = p.getProperty("webservice.url");
